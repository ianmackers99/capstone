...
- This Readme document contains an overview of the challenge, approaches considered and my **Week by week strategy**
...
- [/documentation](https://github.com/ianmackers99/capstone/tree/main/documentation) contains a **Datasheet** for the dataset and a **Model Card**
- [/queries and results](https://github.com/ianmackers99/capstone/tree/main/queries%20and%20results) - contains a **Spreadsheet** with a tab for each function containing queries and results for each each week and the improvement over time
...
The LLM prompts used in weeks 8 through 12 can be found in the [/queries and results/LLM prompts](https://github.com/ianmackers99/capstone/tree/main/queries%20and%20results/LLM%20prompts) directory.
